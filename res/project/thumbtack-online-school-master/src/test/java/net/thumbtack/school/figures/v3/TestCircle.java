...
public class TestCircle {
    ...
    @Test
    public void testCircleSetCenterAndSetRadius() throws ColorException {
        Circle circle = new Circle(10, Color.BLUE);
        circle.setCenter(new Point2D(4,4));
        circle.setRadius(10);
        assertEquals(new Point2D(4,4), circle.getCenter());
        assertEquals(10, circle.getRadius());
    }
    ...
    //new Point2D(0,0),1,Color.BLUE

    @Test
    public void testCircle4C() throws ColorException {
